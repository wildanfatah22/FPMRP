                    ...
                    <form class="form-horizontal form-label-left" action="">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input class="form-control col-md-7 col-xs-12" type="text" name="" value="<?php echo $row['id_distributor']; ?>" readonly>
                        </div>
                      </div>
                      <div class="item form-group">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          <a class="btn btn-primary" href="distributor.php">Kembali</a>
                        </div>
                      </div>

                    </form>
                    <!-- akhir form distributor -->
