        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
              <a href="../laporan/lap_dta_cetak_brngkluar_semua.php" target="_blank">
          ...
          <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
              <div class="x_panel">
                <form class="" action="../laporan/lap_dta_cetak_brngkluarf.php" method="post" target="_blank">
                   ...
                   <table class="table table-striped table-bordered" id="datatables" style="width: 100%">
                     ...
                     <tbody>
                       ...
                       <tr>
                         ...
                         <td align="center">
                           <a class="btn btn-primary" href="../laporan/brng_keluar_cetak_sesuai_id.php?id_transaksi=<?php echo $row['id_transaksi'] ?>" target="_blank"><i class="fa fa-print"></i> </a>
                         </td>
                       </tr>
                       <?php
                       $no++;
