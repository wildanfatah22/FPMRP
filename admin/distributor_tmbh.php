...
<?php
$sql    = "SELECT id_distributor FROM dta_distributor";
...
if ($datkod) {
  ...
  $kode    = (int) $nilkod;
  $kode    = $jumdat + 1;
  $kodeoto = "IDDIS-".str_pad($kode, 4, "0", STR_PAD_LEFT);
} else {
  $kodeoto = "IDDIS-0001";
}
         ...
         <div class="">
           ...
           <div class="row">
             <div class="col-md-12 col-sm-12 col-xs-12">
               <div class="x_panel">
                 <div class="x_title">
                   <h2>Form Distributor</h2>
                   <div class="clearfix"></div>
                 </div>
                 <div class="x_content">

                   <!-- form tambah barang -->
                   <form class="form-horizontal form-label-left" action="distributor_tmbh.php" method="post">

                     <div class="item form-group">
                       <label class="control-label col-md-3 col-sm-3 col-xs-12">ID distributor</label>
                     ...
                     <div class="form-group">
                       <div class="col-md-6 col-md-offset-3">
                         <a class="btn btn-warning" href="distributor.php">Batal</a>
...
<?php
 ...
 if (isset($_POST['tambah'])) {
   ...
   if ($row = $q_idsup->fetch_row()) {
     echo "<script>
             window.alert('Data distributor Dengan ID = ".$idsup." Sudah Ada !');
             window.location=(href='distributor_tmbh.php')
           </script>";
   } else {
     $query  = "INSERT INTO dta_distributor (id_distributor, nama, nomor, fax, email, website, alamat)
                VALUES ('$idsup', '$nma', '$nmo', '$fax', '$email', '$web', '$alamat')";
     $result = $mysqli->query($query);

     echo "<script>
             window.location=(href='distributor.php?&simpan')
           </script>";
   }
 }
 ?>
