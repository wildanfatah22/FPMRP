             ...
             <div class="col-md-12 col-sm-12 col-xs-12">
               <div class="x_panel">
                 ...
                 <div class="x_content">
                   ...
                   <!-- form tambah barang -->
                   <form class="form-horizontal form-label-left" action="distributor_proses_ubah.php" method="post">

                     <div class="item form-group">
                       <label class="control-label col-md-3 col-sm-3 col-xs-12">ID distributor</label>
                       <div class="col-md-6 col-sm-6 col-xs-12">
                         <input class="form-control col-md-7 col-xs-12" type="text" name="inpid" value="<?php echo $_GET['id_distributor']; ?>" readonly>
                       </div>
                     </div>
                     <div class="item form-group">
